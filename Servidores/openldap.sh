...
##     INSTRUCCIONES      ##
############################
## Gestiona tareas del servidor openldap
...
while :
    ...
    case $OPCION in
        ...
        1)  ## Deshabilitar del inicio
            clear
            sudo systemctl disable openldap
            read -p "Pulsa una tecla para continuar" input
            continue;;

        2)  ## Habilitar al inicio
            clear
            sudo systemctl enable openldap
            read -p "Pulsa una tecla para continuar" input
            continue;;

        3)  ## Apagar
            clear
            sudo systemctl stop openldap
            read -p "Pulsa una tecla para continuar" input
            continue;;
        ...
        6)  ## Reinicio Seguro
            clear
            sudo systemctl reload openldap
            read -p "Pulsa una tecla para continuar" input
            continue;;
